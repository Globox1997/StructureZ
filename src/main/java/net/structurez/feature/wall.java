...
import net.structurez.generator.wallgenerator;

import java.util.Random;
import java.util.function.Function;

public class wall extends StructureFeature<DefaultFeatureConfig> {
  public wall(Function<Dynamic<?>, ? extends DefaultFeatureConfig> configFactory) {
    super(configFactory);
  }
  ...
  public StructureStartFactory getStructureStartFactory() {
    return wall.Start::new;
  }

  @Override
  public String getName() {
    return struc.MOD_ID + ":wall";
  }
  ...
  public static class Start extends StructureStart {
    ...
    public void initialize(ChunkGenerator<?> chunkGenerator, StructureManager structureManager, int x, int z,
      ...
      wallgenerator.addPieces(structureManager, blockPos, blockRotation, this.children, this.random);
