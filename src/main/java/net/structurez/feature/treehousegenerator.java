...
public class treehousegenerator {
  private static final Identifier SE_TEMPLATE = new Identifier(struc.MOD_ID + ":houses/treehouse");
  ...
  public static void addPieces(StructureManager manager, BlockPos pos, BlockRotation rotation,
    ...
    pieces.add(new treehousegenerator.Piece(manager, SE_TEMPLATE, pos, rotation));
  ...
  public static class Piece extends SimpleStructurePiece {
    ...
    public Piece(StructureManager manager, Identifier identifier, BlockPos pos, BlockRotation rotation) {
      ...
      BlockPos blockPos = (BlockPos) treehousegenerator.COUNTER_OFFSET.get(identifier);
    ...
    private void initializeStructureData(StructureManager manager) {
      ...
      StructurePlacementData structurePlacementData = (new StructurePlacementData()).setRotation(this.rotation)
          .setMirrored(BlockMirror.NONE).setPosition((BlockPos) treehousegenerator.PIECES_OFFSET.get(this.template))
    ...
    public boolean generate(IWorld world, ChunkGenerator<?> generator, Random random, BlockBox box, ChunkPos pos) {
      ...
      if ((world.getBlockState(dirt.up()).isAir() || world.getBlockState(dirt.up()).getBlock().equals(Blocks.GRASS))
          ...
          && (world.getBlockState(dirt.south(12).east(12).up()).isAir()
              ...
              || world.getBlockState(dirt.south(12).east(12).up()).getBlock().equals(Blocks.SNOW))
          &&

          (world.getBlockState(dirt.south(16).up()).isAir()
              || world.getBlockState(dirt.south(16).up()).getBlock().equals(Blocks.GRASS)
              || world.getBlockState(dirt.south(16).up()).getBlock().equals(Blocks.SNOW))
          && (world.getBlockState(dirt.east(16).up()).isAir()
              || world.getBlockState(dirt.east(16).up()).getBlock().equals(Blocks.GRASS)
              || world.getBlockState(dirt.east(16).up()).getBlock().equals(Blocks.SNOW))
          && (world.getBlockState(dirt.south(16).east(16).up()).isAir()
              || world.getBlockState(dirt.south(16).east(16).up()).getBlock().equals(Blocks.GRASS)
              || world.getBlockState(dirt.south(16).east(16).up()).getBlock().equals(Blocks.SNOW))
          &&
          ...
          && (world.getBlockState(dirt.east(16)).getBlock().equals(Blocks.GRASS_BLOCK)
              || world.getBlockState(dirt.east(16)).getBlock().equals(Blocks.DIRT))

          && (world.getBlockState(dirt.south(16).east(16)).getBlock().equals(Blocks.GRASS_BLOCK)
              || world.getBlockState(dirt.south(16).east(16)).getBlock().equals(Blocks.DIRT))

          && world.getBlockState(dirt.up(10)).isAir() && world.getBlockState(dirt.south(16).up(10)).isAir()
          && world.getBlockState(dirt.east(16).up(10)).isAir()
          && world.getBlockState(dirt.south(16).east(16).up(10)).isAir() && world.getBlockState(dirt.up(5)).isAir()
          && world.getBlockState(dirt.south(16).up(5)).isAir() && world.getBlockState(dirt.east(16).up(5)).isAir()
          && world.getBlockState(dirt.south(16).east(16).up(5)).isAir()) {

        StructurePlacementData structurePlacementData = (new StructurePlacementData()).setRotation(this.rotation)
            .setMirrored(BlockMirror.NONE).setPosition((BlockPos) treehousegenerator.PIECES_OFFSET.get(this.template))
            .addProcessor(BlockIgnoreStructureProcessor.IGNORE_STRUCTURE_BLOCKS);
        BlockPos blockPos = (BlockPos) treehousegenerator.COUNTER_OFFSET.get(this.template);
