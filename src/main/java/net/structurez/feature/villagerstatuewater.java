...
import net.structurez.generator.villagerstatuewatergenerator;

import java.util.Random;
import java.util.function.Function;

public class villagerstatuewater extends StructureFeature<DefaultFeatureConfig> {
  public villagerstatuewater(Function<Dynamic<?>, ? extends DefaultFeatureConfig> configFactory) {
    super(configFactory);
  }
  ...
  public static class Start extends StructureStart {
    ...
    public void initialize(ChunkGenerator<?> chunkGenerator, StructureManager structureManager, int x, int z,
      ...
      villagerstatuewatergenerator.addPieces(structureManager, blockPos, blockRotation, this.children, this.random);
