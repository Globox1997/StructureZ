...
public class treehouse extends StructureFeature<DefaultFeatureConfig> {
  ...
  public static class Start extends StructureStart {
    ...
    public void initialize(ChunkGenerator<?> chunkGenerator, StructureManager structureManager, int x, int z,
      ...
      treehousegenerator.addPieces(structureManager, blockPos, blockRotation, this.children, this.random);
