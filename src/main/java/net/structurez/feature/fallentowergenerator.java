...
public class fallentowergenerator {
  private static final Identifier SE_TEMPLATE = new Identifier(struc.MOD_ID + ":stuff/fallentower");
  ...
  public static void addPieces(StructureManager manager, BlockPos pos, BlockRotation rotation,
    ...
    pieces.add(new fallentowergenerator.Piece(manager, SE_TEMPLATE, pos, rotation));
  ...
  public static class Piece extends SimpleStructurePiece {
    ...
    public Piece(StructureManager manager, Identifier identifier, BlockPos pos, BlockRotation rotation) {
      super(featuring.FALLENTOWER_PIECES, 0);
      this.template = identifier;
      BlockPos blockPos = (BlockPos) fallentowergenerator.COUNTER_OFFSET.get(identifier);
    ...
    public Piece(StructureManager manager, CompoundTag tag) {
      super(featuring.FALLENTOWER_PIECES, tag);
    ...
    private void initializeStructureData(StructureManager manager) {
      ...
      StructurePlacementData structurePlacementData = (new StructurePlacementData()).setRotation(this.rotation)
          .setMirrored(BlockMirror.NONE).setPosition((BlockPos) fallentowergenerator.PIECES_OFFSET.get(this.template))
    ...
    public boolean generate(IWorld world, ChunkGenerator<?> generator, Random random, BlockBox box, ChunkPos pos) {
      ...
      if ((world.getBlockState(dirt.up()).isAir() || world.getBlockState(dirt.up()).getBlock().equals(Blocks.GRASS))
          ...
          (world.getBlockState(dirt.south(14).up()).isAir()
              || world.getBlockState(dirt.south(14).up()).getBlock().equals(Blocks.GRASS))
          && (world.getBlockState(dirt.east(14).up()).isAir()
              || world.getBlockState(dirt.east(14).up()).getBlock().equals(Blocks.GRASS))
          && (world.getBlockState(dirt.south(13).east(14).up()).isAir()
              || world.getBlockState(dirt.south(14).east(14).up()).getBlock().equals(Blocks.GRASS))
          &&
          ...
          && (world.getBlockState(dirt.south(14)).getBlock().equals(Blocks.GRASS_BLOCK)
              || world.getBlockState(dirt.south(14)).getBlock().equals(Blocks.DIRT))

          && (world.getBlockState(dirt.east(14)).getBlock().equals(Blocks.GRASS_BLOCK)
              || world.getBlockState(dirt.east(14)).getBlock().equals(Blocks.DIRT))

          && (world.getBlockState(dirt.south(14).east(14)).getBlock().equals(Blocks.GRASS_BLOCK)
              || world.getBlockState(dirt.south(14).east(14)).getBlock().equals(Blocks.DIRT))

          && world.getBlockState(dirt.up(5)).isAir() && world.getBlockState(dirt.south(16).up(5)).isAir()
          && world.getBlockState(dirt.east(14).up(5)).isAir()
          && world.getBlockState(dirt.south(14).east(14).up(5)).isAir()) {

        StructurePlacementData structurePlacementData = (new StructurePlacementData()).setRotation(this.rotation)
            .setMirrored(BlockMirror.NONE).setPosition((BlockPos) fallentowergenerator.PIECES_OFFSET.get(this.template))
            .addProcessor(BlockIgnoreStructureProcessor.IGNORE_STRUCTURE_BLOCKS);
        BlockPos blockPos = (BlockPos) fallentowergenerator.COUNTER_OFFSET.get(this.template);
