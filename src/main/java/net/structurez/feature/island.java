...
import net.structurez.generator.islandgenerator;

import java.util.Random;
import java.util.function.Function;

public class island extends StructureFeature<DefaultFeatureConfig> {
  public island(Function<Dynamic<?>, ? extends DefaultFeatureConfig> configFactory) {
    super(configFactory);
  }
  ...
  public StructureStartFactory getStructureStartFactory() {
    return island.Start::new;
  }

  @Override
  public String getName() {
    return struc.MOD_ID + ":island";
  }
