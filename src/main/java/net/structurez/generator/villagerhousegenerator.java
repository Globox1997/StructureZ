...
public class villagerhousegenerator {
  private static final Identifier VILL = new Identifier(struc.MOD_ID + ":houses/villagerhouse");
  ...
  public static void addPieces(StructureManager manager, BlockPos pos, BlockRotation rotation,
    ...
    pieces.add(new villagerhousegenerator.Piece(manager, VILL, pos, rotation));
  ...
  public static class Piece extends SimpleStructurePiece {
    ...
    public boolean generate(IWorld world, ChunkGenerator<?> generator, Random random, BlockBox box, ChunkPos pos) {
      ...
      if ((world.getBlockState(dirt.up()).isAir() || world.getBlockState(dirt.up()).getBlock().equals(Blocks.GRASS))
          ...
          && world.getBlockState(dirt.south(11)).getBlock().equals(Blocks.GRASS_BLOCK)
          && (world.getBlockState(dirt.east(9).south(11)).getBlock().equals(Blocks.GRASS_BLOCK)
              || world.getBlockState(dirt.east(9).south(11)).getBlock().equals(Blocks.DIRT))

          && world.getBlockState(dirt.up(10)).isAir() && world.getBlockState(dirt.up(10).east(9).south(11)).isAir()) {
