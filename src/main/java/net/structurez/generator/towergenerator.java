    ...
    public boolean generate(IWorld world, ChunkGenerator<?> generator, Random random, BlockBox box, ChunkPos pos) {
      ...
      if ((world.getBlockState(dirt.up()).isAir() || world.getBlockState(dirt.up()).getBlock().equals(Blocks.SNOW))
          && (world.getBlockState(dirt.up().east(9)).isAir()
              || world.getBlockState(dirt.up().east(9)).getBlock().equals(Blocks.SNOW))
          && (world.getBlockState(dirt.up().south(9)).isAir()
              || world.getBlockState(dirt.up().south(9)).getBlock().equals(Blocks.SNOW)
              || world.getBlockState(dirt.east(9).south(9)).getBlock().equals(Blocks.GRAVEL)
              || world.getBlockState(dirt.east(9).south(9)).getBlock().equals(Blocks.STONE))
          && (world.getBlockState(dirt.up().east(9).south(9)).isAir()
              || world.getBlockState(dirt.up().east(9).south(9)).getBlock().equals(Blocks.SNOW)
              || world.getBlockState(dirt.east(9).south(9)).getBlock().equals(Blocks.GRAVEL)
              || world.getBlockState(dirt.east(9).south(9)).getBlock().equals(Blocks.STONE))

          && (world.getBlockState(dirt).getBlock().equals(Blocks.STONE)
              || world.getBlockState(dirt).getBlock().equals(Blocks.GRAVEL)
              || world.getBlockState(dirt).getBlock().equals(Blocks.GRASS_BLOCK))
          && (world.getBlockState(dirt.east(9)).getBlock().equals(Blocks.STONE)
              || world.getBlockState(dirt.east(9)).getBlock().equals(Blocks.GRAVEL)
          ...
          && (world.getBlockState(dirt.south(9)).getBlock().equals(Blocks.STONE)
              || world.getBlockState(dirt.south(9)).getBlock().equals(Blocks.GRAVEL)
              || world.getBlockState(dirt.south(9)).getBlock().equals(Blocks.GRASS_BLOCK))
          && (world.getBlockState(dirt.east(9).south(9)).getBlock().equals(Blocks.STONE)
              || world.getBlockState(dirt.east(9).south(9)).getBlock().equals(Blocks.GRAVEL)
              || world.getBlockState(dirt.east(9).south(9)).getBlock().equals(Blocks.GRASS_BLOCK))
